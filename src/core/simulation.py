...
class Simulation(object):
    ...
    def __init__(self, name, raw_data_set):
        ...
        self._pileup = False
        self._pileup_window = 450.0 # in ns was 400
    def generate(self):
    ...
    def set_pileup(self, calc_pileup, pileup_window=450.0): # before was 400.
    ...
    def set_signal_rejection(self, signal_rejection):
        """ Set the rejection type."""
        self._signal = signal_rejection
    ################################################################################################
